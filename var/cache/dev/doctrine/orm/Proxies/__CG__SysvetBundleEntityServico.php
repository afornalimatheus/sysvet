 ...
 */
class Servico extends \SysvetBundle\Entity\Servico implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SysvetBundle\\Entity\\Servico' . "\0" . 'id', '' . "\0" . 'SysvetBundle\\Entity\\Servico' . "\0" . 'nome', '' . "\0" . 'SysvetBundle\\Entity\\Servico' . "\0" . 'descricao', '' . "\0" . 'SysvetBundle\\Entity\\Servico' . "\0" . 'preco'];
        }
