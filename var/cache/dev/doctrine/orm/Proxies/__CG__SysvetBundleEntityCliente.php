...
namespace Proxies\__CG__\SysvetBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Cliente extends \SysvetBundle\Entity\Cliente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SysvetBundle\\Entity\\Cliente' . "\0" . 'id', '' . "\0" . 'SysvetBundle\\Entity\\Cliente' . "\0" . 'nome', '' . "\0" . 'SysvetBundle\\Entity\\Cliente' . "\0" . 'email', '' . "\0" . 'SysvetBundle\\Entity\\Cliente' . "\0" . 'telefone', '' . "\0" . 'SysvetBundle\\Entity\\Cliente' . "\0" . 'documento', '' . "\0" . 'SysvetBundle\\Entity\\Cliente' . "\0" . 'dataCadastro', '' . "\0" . 'SysvetBundle\\Entity\\Cliente' . "\0" . 'sexo'];
        }
